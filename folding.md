...
:::{seealso} Python implementation
Head over [here](./notebooks/RNA_folding.ipynb) for Jupyter notebook containing code implementing the algorithms discussed here. My version of Zuker's algorithm is highly simplified so that the code is as short and readable as possible.
:::
